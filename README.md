...
- 2[ ] Create an html file with the name of "index" in the root of the project
- 2[ ] Add HTML Boilerplate to the document
- 2[ ] Set the document title to be "Jon Doe's resume".
